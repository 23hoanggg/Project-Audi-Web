    ...
    <Navbar expand="lg" className="bg-body-tertiary-white mt-2 mb-2 px-5" id='#'>
      <Container fluid>
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0 fs-4 d-flex " style={{ maxHeight: '100px', alignItems: 'center' }} navbarScroll>
          ...
          {isSearchFormVisible ? (
            <Form className="d-flex" style={{ backgroundColor: 'transparent' }}>
              ...
              />
              <Button variant="outline-light" className="text-dark fs-5" onClick={handleSearch}>
                search
              </Button>
            </Form>
          ) : (
            <Button variant="outline-light" className="text-dark fs-4" onClick={toggleSearchForm}>
