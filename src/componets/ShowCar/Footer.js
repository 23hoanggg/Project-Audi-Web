                ...
                <ul style={{ listStyle: 'none' }} className="List-Footer">
                    <div className="Box-Footer">
                        {blockFeatures.map((item) => (
                            <div key={blockFeatures.id} className="Content-Feature">
                                <div>
                                    <h2 className="Title-Feature">{item.nameTitleFeature}</h2>
                                </div>
                                <div >
                    ...
                    <div className="Container-BackToTop">
                        ...
                        <div className="Container-Icon">
                            <div>
                                <svg width="20" height="30" viewBox="0 0 896 1664" xmlns="http://www.w3.org/2000/svg" className="Social-Media">
                            ...
                            <div>
                                <svg width="30" height="30" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="Social-Media">
